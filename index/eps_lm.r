func <- function(k="2000-01-01::2018-12-31" ,l=5){
  ...
  SP5.result <<- merge(residuals(result.gpu),predict(result.gpu),residuals(result.eps),predict(result.eps))
...
# func("2000-01-01::2019-06-30",5)
func(paste("2010-01-01::",as.Date(as.yearmon((mondate(index(last(G)))+2)),frac=1),sep=""),10)

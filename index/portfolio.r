...
addTA(t,on=1,legend="",lty=2,order=10)
t <- as.xts(rep(2800000,length(weekly_pf[,1])),index(weekly_pf))
addTA(t,on=1,legend="",lty=2,order=10)
t <- as.xts(rep(2600000,length(weekly_pf[,1])),index(weekly_pf))
addTA(t,on=1,legend="",lty=2,order=10)
t <- as.xts(rep(2400000,length(weekly_pf[,1])),index(weekly_pf))
addTA(t,on=1,legend="",lty=2,order=10)
t <- as.xts(rep(2200000,length(weekly_pf[,1])),index(weekly_pf))
addTA(t,on=1,legend="",lty=2,order=10)
...
# plot(addLines(h=2300000))
# plot(addLines(h=2400000))
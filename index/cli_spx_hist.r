...
plot.zoo(merge(log(to.monthly(SP5)[mnt_plus][,4]),log(to.monthly(SP5)[mnt_minus][,4])),type='h',col = c("blue", "red"), plot.type = "single",lwd=4,main='cli_spx_hist.r',xlab='',ylab='')

...
# i = number of months to calculate delta.
...
my_sp5eps <- function(k,e,p,u,c,o)
{
  ...
  m_m <- summary(lm(apply.quarterly(SP5[,4][k2k],mean) ~ eps_year_xts[k2k]+apply.quarterly(PA[k2k],mean)+apply.quarterly(UC[k2k],mean)+apply.quarterly(CS[k2k],mean)+apply.quarterly(diff(cli_xts$oecd,lag=6)[k2k],mean)))$coefficients
...
my_sp5eps <- function(k,e,p,u,c,o,i)
{

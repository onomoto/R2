...
plot.zoo(merge(VIX[paste("2000::",substr(as.character(index(last(cli_xts)))[-4],1,7),sep="")][,4],VIX[mnt][,4]),type='h',col = c("red", "blue"), plot.type = "single")
...
plot.default(SP5[,4][paste("2000::",substr(as.character(index(last(cli_xts)))[-4],1,7),sep="")],axes=F,type='l')

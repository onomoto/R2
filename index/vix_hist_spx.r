...
mnt4 <- index(cli_xts$oecd["2000::"][na.omit(diff(cli_xts$oecd["1999-07-01::"],lag=6)) < 0 & na.omit(diff(cli_xts$oecd["1999-12-01::"])) < 0])
# plot.zoo(merge(VIX["2000::2019-02"][,4],VIX[mnt4][,4]),type='h',col = c("red", "blue"), plot.type = "single")
plot.zoo(merge(VIX[paste("2000::",substr(as.character(index(last(cli_xts))),1,7),sep="")][,4],VIX[mnt4][,4]),type='h',col = c("red", "blue"), plot.type = "single")

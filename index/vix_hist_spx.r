...
plot.zoo(merge(VIX[period][,4],VIX[mnt4][,4]),type='h',col = c("blue", "red"), plot.type = "single",main='vix_hist_spx.r',ylab='VIX')
...
plot.default(to.monthly(SP5)[,4][period],axes=F,type='l',xlab='',ylab='')

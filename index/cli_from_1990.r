...
par(new=T)
hist(as.vector(VIX[as.Date(index(na.trim(diff(cli_xts$oecd["1990::"],lag=4))[na.trim(diff(cli_xts$oecd["1990::"],lag=4)) < -0.2 ]))][,4]),xlim=c(5,60),ylim=c(0,60),col=rgb(0,0,1,alpha=0.4),breaks=20)

...
p <- p + geom_hline(yintercept = log(s),size=0.2,linetype=1,colour="brown") #horizontal line
...
p <- p+theme(axis.title.x=element_blank(),axis.title.y=element_blank(),axis.text.y=element_blank(),axis.ticks.y=element_blank())

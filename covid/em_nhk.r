...
# g <- g + scale_fill_manual(name='regions',values=rep(my_palette(12),4)[-48],labels=pref_jp)
g <- g + scale_fill_manual(name='regions',values=my_palette(47),labels=pref_jp)
# g <- g + scale_fill_hue(name='regions',labels=pref_jp)
# g <- g + scale_color_discrete(name='regions',values=rep(my_palette(6),8)[-48] ,lables=pref_jp)

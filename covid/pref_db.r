...
pref_db <- cbind(as.data.frame(pref_lab),pref_en,read.csv("~/Downloads/c02.csv",fileEncoding = "shift_jis",colClasses = c(rep(NA,9),rep("integer",4)),skip=1)[3:49,c(8,10,11,12,13)])
# pref_db <- pref_db[,-4]

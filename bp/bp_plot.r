...
events <- xts(c("weight","70k","75k","80k","85k","90k","95k"),as.Date(c("2018-07-14","2019-01-23","2019-02-14","2019-03-15","2019-4-16","2019-06-07","2019-07-01")))
for(i in seq(1,length(index(events)),1)){
  addEventLines(events[i], srt=90, pos=2,col=10)
}
